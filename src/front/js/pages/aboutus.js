...
function AboutUs() {
  return (
    <>
      <div
        className="container-fluid aboutus justify-content-center pb-5"
        style={{ backgroundImage: `url(${img})` }}
      >
        <div
          className="d-flex container-fluid upperhero"
          ...
          <div className="row">
            <div className="col-md-9 offset-md-1">
              <div className="lc-block mt-5">
                <div editable="rich">
                  <p className="lead text-black fs-3">
                    Como tú, siempre hemos buscado el enriquecernos con
                    actividades recreativas y culturales, son necesarias para
                    todos y son parte fundamental de la vida de una persona
                    sana.
                  </p>
                  <p className="lead text-black fs-3">
                    {" "}
                    Queremos facilitar que esto pase, tanto para quienes hacen
                    los eventos, como para quienes asisten. Vamos a hacer crecer
                    a todos los que formen parte de un evento con Wow, y
                    hacerlos vivir una experiencia inolvidable.{" "}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="scrolldown1 container-fluid py-5">
        ...
        <div className="d-flex flex-wrap justify-content-around mt-5">
          <div className="d-flex flex-wrap images-per-con mb-3 justify-content-center">
            <img src={juan} className="h-5 images-person mb-3 juan"></img>
            <h3>Juan Araque</h3>
            <h5 className="text-center d-flex">
              Estudiante de ingeniería en sistemas, 19 años.
            </h5>
          </div>
          <div className="d-flex flex-wrap images-per-con mb-3 justify-content-center">
            <img src={joel} className="h-5 images-person mb-3 joel"></img>
            <h3>Joel Leonardo Medina</h3>
            <h5 className="text-center d-flex">
              Ingeniero en sistemas, Frontend developer, 34 años.
            </h5>
          </div>
          <div className="d-flex flex-wrap images-per-con mb-3 justify-content-center">
            <img src={tito} className="h-5 images-person tito mb-3"></img>
            <h3>Tito Ángel Balza</h3>
            <h5 className="text-center d-flex">
              Estudiante de economía empresarial, 19 años.
            </h5>
          </div>
        </div>
      </div>
